	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		restActions.getVideos(listTag, new Callback<List<Video>>() {
			...
			public void call(List<Video> result) {
				...
				final ArrayAdapter adapter = new ArrayAdapter(VideosActivity.this, android.R.layout.simple_expandable_list_item_1, list);
				listview.setAdapter(adapter);
				listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					@Override
					public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
						final Intent intent = new Intent(VideosActivity.this, VideoViewActivity.class);
